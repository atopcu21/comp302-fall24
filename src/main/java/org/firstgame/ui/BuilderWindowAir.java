...
public class BuilderWindowAir extends JPanel implements MouseListener, MouseMotionListener {
    ...
    private BuilderWindowAir() {
        ...
        levelLabel = new JLabel("Building Air Hall");
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        if(clickPoint.x >= 925 && clickPoint.x <= 925 + 70 && clickPoint.y >= 582 && clickPoint.y <= 582 + 36 && placedObjects.size() >= 9) {
    ...
    public void goToNextLevelBuilder() {
        ...
        RokueLikeGame.getInstance().addGameObjects(placedObjects, "Air");
        BuilderWindowWater.getInstance();
    }
